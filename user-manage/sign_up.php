...
<div class="row">
    ...
    <h1><?php _e('Create a new account'); ?></h1>
		...
		<form class="" method="post" action="sign_up.php" id="sign-up-form" accept-charset="ISO-8859-1">
			<fieldset>
			...
			<button type="submit" class="btn btn-primary create-acount-new"><?php _e('Create my account'); ?></button>
		</form>
	</div>
	<!--<div class="col-md-6">
		<h1><?php _e('Create a new account'); ?></h1>
