...
<div class="row">
	<div class="main login col-md-4">
		...
		<input type="hidden" name="token" value="<?php echo $_SESSION['imsrt']['token']; ?>"/>
		<input type="submit" value="<?php _e('Login'); ?>" class="btn btn-primary create-acount-new login-submit" id="login-submit" name="login"/>

		<label class="remember" for="remember">
			<input type="checkbox" id="remember" name="remember"/><span><?php _e('Stay signed in'); ?></span>
		</label>

		<p class="signup"><a href="sign_up.php"><?php _e('New to vndmi?  <strong>Join today!</strong>'); ?></a></p>
