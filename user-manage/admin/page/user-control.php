	...
	<div class="col-md-9 pull-right">
		<form method="post" id="search-users-form" action="classes/add_user.class.php" class="form-inline">
			<div class="form-group">
            	<button id="upload_user_file_btn" class="btn btn-default"><?php _e('Upload user from file'); ?></button>
			  ...
			  <input type="number" class="form-control input-mini" min="0" id="showUsers" name="showUsers" placeholder="<?php _e('Show'); ?>" value="<?php echo !empty($_SESSION['imsrt']['users_page_limit']) ? $_SESSION['imsrt']['users_page_limit'] : 10; ?>">
			</div>
		</form>
	</div>
...
<div id="upload_user" style="display:none;">
	<?php include_once('user-upload.php'); ?>
</div>
...
<script>
$('#upload_user_file_btn').click(function(e) {

	e.preventDefault();
	$('#upload_user').slideToggle();
