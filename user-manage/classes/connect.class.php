...
class Connect {
	...
	public function dbConn() {
		...
		try {
			...
			self::$dbh = new PDO("mysql:host={$host};dbname={$dbName}", $dbUser, $dbPass,array( PDO::ATTR_PERSISTENT => false, PDO::MYSQL_ATTR_USE_BUFFERED_QUERY=>true, PDO::MYSQL_ATTR_LOCAL_INFILE =>true));
