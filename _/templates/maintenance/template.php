...
<head>
<meta charset="utf-8"/>
<title>VNEFRC | Vietnam Economics & Financial Research Center</title>
...
<link href="<?php echo template_url(); ?>admin/pages/css/coming-soon.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE LEVEL STYLES -->
<!-- BEGIN THEME STYLES -->
<link href="<?php echo template_url(); ?>global/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
<link href="<?php echo template_url(); ?>global/css/plugins.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo template_url(); ?>admin/layout/css/layout.css" rel="stylesheet" type="text/css"/>
<link id="style_color" href="<?php echo template_url(); ?>admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo template_url(); ?>admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<div class="container">
	<div class="row">
		<div class="col-md-12 coming-soon-header">
				...
				<h3 style="margin-top: 8px; margin-bottom: 8px;color:#fcd116 !important; font-weight: bold;">VIETNAM <span style="color: red;"> <?php echo trans('title_home')?></span></h3>
	...
	<div class="row">
		<div class="col-md-12 coming-soon-content">
			...
			<p>
				 We are currently working on this feature , but be sure to come and check back , as we will be releasing this feature soon!
			</p>
			<br>
            <a class="btn btn-default btn-sm" href="<?php echo base_url().'user-manage/login.php' ?>">
            Admin Panel
            </a>
...
<script src="<?php echo template_url(); ?>global/plugins/countdown/jquery.countdown.min.js" type="text/javascript"></script>
<script src="<?php echo template_url(); ?>global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
...
<script src="<?php echo template_url(); ?>admin/pages/scripts/coming-soon.js" type="text/javascript"></script>
...
Demo.init(); // init demo features
  ...
  // init background slide images
    $.backstretch([
            "<?php echo template_url(); ?>admin/pages/media/bg/1.jpg",
            "<?php echo template_url(); ?>admin/pages/media/bg/2.jpg",
            "<?php echo template_url(); ?>admin/pages/media/bg/3.jpg",
    "<?php echo template_url(); ?>admin/pages/media/bg/4.jpg"
        ], {
        fade: 1000,
        duration: 10000
   });
