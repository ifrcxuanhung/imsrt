...
$db['database']['hostname'] = 'local';
$db['database']['username'] = 'local';
$db['database']['password'] = 'ifrcvn';
$db['database']['database'] = 'vnxindex_data';
...
$db['database2']['database'] = 'vnvdm_demo';
