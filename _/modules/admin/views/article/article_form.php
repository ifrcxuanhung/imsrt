            ...
            <div class="block-content">
                ...
                <div class="columns">
                    ...
                    <div class="columns">
                     ...
                     <div class="columns">
                        <p class="colx3-left inline-label">
                            <span class="label"><?php trans('date_added'); ?></span>
                            <span class="relative">
                                <?php
                                if (isset($input['date_added'])== FALSE) : $input['date_added'] = date('d-m-Y');
                                endif;
                                echo form_input('date_added', set_value('date_added', $input['date_added']), 'class =full-width date_added');
                                ?>
                            </span>
                        </p>
                    </div>
                    ...
                    <div class="columns">
                        <p class="colx3-left inline-label">
                            <span class="label"><?php trans('show_index'); ?></span>
                            <span class="relative">
                            <?php
                                $checked = @$input['show_index'] == 1 ? " checked = 'checked' " : "";
                            ?>
                                <input type="checkbox" name="show_index" value="1" <?php echo $checked ?>  />
                            </span>
                        </p>
                    </div>
                    <div class="columns">
