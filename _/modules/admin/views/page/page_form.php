<form name="formPage" class="form" id="complex_form" method="post" action="">
        ...
        <div class="block-border">
            <div class="block-content">
                ...
                <div class="columns">
                    ...
                    <div class="columns">
                        <p class="colx3-left inline-label">
                            <span class="label required"><?php trans('layout'); ?></span>
                            <span class="relative">
                    ...
                    <div id="layout_id" class="columns hidden">
                        <p class="colx3-left inline-label">
                            ...
                            <span class="relative">
                                <?php
                                $options = array(trans('select_layout', 1), 'list.php', 'detail.php');
                    ...
                    <div class="columns">
                        <p class="colx3-left inline-label">
                            ...
                            <span class="relative">
                                <?php
                                $options = array('desc' => trans('order_descending', 1), 'asc' => trans('order_ascending', 1));
                                echo form_dropdown('sort_order', $options, isset($input['sort_order']) ? $input['sort_order'] : 0, 'class =full-width');
                                ?>
                            </span>
                        </p>
                    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('select[name="layout_id"]').live('change', function(){
            $('#layout').val('');
            if($(this).val() != 0) {
                $('#layout').val($("#layout_id").find('option:selected[value='+$(this).val()+']').text());
            }
        })
