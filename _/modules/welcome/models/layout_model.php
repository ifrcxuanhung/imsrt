...
class Layout_model extends CI_Model{
    ...
    function loadSubcatbyCategory($cate){
        $sql ="SELECT int_a.subcat FROM int_article as int_a LEFT JOIN int_article_category as int_c ON int_c.category = int_a.category_code and int_c.subcat = int_a.subcat WHERE int_a.category_code ='".$cate."' GROUP BY int_a.subcat ORDER BY int_c.order ASC";
