...
class Jq_realtime extends Welcome{
    ...
    public function index($idx_code){
		...
		$column1 = $this->jq_realtime_model->js_sys_format($table_one);
		$column2 = $this->jq_realtime_model->js_sys_format($table_two);
		$column3 = $this->jq_realtime_model->js_sys_format($table_three);
		$column4 = $this->jq_realtime_model->js_sys_format($table_four);
		$column5 = $this->jq_realtime_model->js_sys_format($table_five);
		...
		$this->data->codeint = json_encode($this->db->select('codeint')->where('idx_code',$idx_code)
		...
		$this->data->summary_des1 = $this->jq_realtime_model->get_summary_des($table_one);
		$this->data->summary_des2 = $this->jq_realtime_model->get_summary_des($table_two);
		$this->data->summary_des3 = $this->jq_realtime_model->get_summary_des($table_three);
		$this->data->summary_des4 = $this->jq_realtime_model->get_summary_des($table_four);
		$this->data->summary_des5 = $this->jq_realtime_model->get_summary_des($table_five);
