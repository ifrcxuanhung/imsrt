...
class Search extends Welcome{
    ...
    public function __construct() {
        parent::__construct();
		$this->load->database();
		$this->load->model('search_model', 'table');
    }
    ...
    public function index(){
		...
		/* $this->data->column = str_replace('}]','}',str_replace('[{"','{',str_replace(',"',',',str_replace('":',':',json_encode($this->search_model->js_sys_format($tables))))));*/
		$column = $this->search_model->js_sys_format($tables);
		...
		$this->data->summary_des = $this->search_model->get_summary_des($tables);
