...
<div class="col-md-12" style="padding-left:0px; padding-right:0px;">
   ...
   <?php //echo "<pre>";print_r($column);exit;?>
   <div class="col-md-4" style="z-index:1000;  position: absolute; right: 20px; top: 8px;">
    ...
    <table id="jqGrid" class="jq_table" attr="<?php echo $table;?>" order_by="<?php echo $summary_des['order_by'];?>" summary_des="<?php echo $summary_des['description']?>" admin ="<?php echo $this->session->userdata_vnefrc('user_id');?>">
