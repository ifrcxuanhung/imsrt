...
<div class="col-md-12" style="padding-left:10px; z-index:0;">
...
<div class="col-md-6" style="padding-left:10px; margin-top:30px;">
...
<div class="col-md-6 block_map" style="padding-left:10px; margin-top:30px;" >
    <!-- BEGIN PORTLET-->
    <div class="portlet box " style="background-color: #89c4f4 !important; border: 1px solid #89c4f4;">
        <div class="portlet-title">
            <div class="caption">
                <i class="icon-share font-red-sunglo hide"></i>
                <span class="caption-subject bold uppercase" style="color: #606060;"><?php echo trans('CHART_title') ?></span>
                <span class="caption-helper" style="color: #606060;"><?php echo trans('CHART_subtitle') ?></span>
            </div>
        </div>
