    	...
    	<div class="col-md-3">
    		<ul class="ver-inline-menu tabbable margin-bottom-10 text-uppercase">
    			...
    			<li class="<?php echo $k == 1 ? 'active' : ''; ?>">
    				...
    				<i class="fa fa-briefcase" style="color: transparent;"></i><?php echo trans($value['subcat']) ?></a>
    						...
    						<div class="panel-heading">
                                ...
                                <div class="panel-toolbar">
                					<div class="btn-group pull-right" style="margin-top: -25px;">
                                        <a class="btn btn-icon-only default show-modal" type-modal="update" keys_value="<?php echo $va['id'] ?>" table_name="<?php echo 'int_article' ?>"  data-target="#modal" data-toggle="modal">
