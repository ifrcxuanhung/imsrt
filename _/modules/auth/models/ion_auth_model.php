...
class Ion_auth_model extends CI_Model {
    ...
    public function login($identity, $password, $remember = FALSE) {
        ...
        $query = $this->db->select($this->identity_column . ', username, first_name, email, avatar, id, password, active, last_login, services')
        ...
        if ($query->num_rows() === 1) {
            ...
            if ($password === TRUE) {
                ...
                $this->session->set_userdata_vnefrc($session_data);
    ...
    public function user($id = NULL) {
        ...
        $id || $id = $this->session->userdata_vnefrc('user_id');
    ...
    public function add_to_group($group_id, $user_id = false) {
        ...
        //if no id was passed use the current users id
        $user_id || $user_id = $this->session->userdata_vnefrc('user_id');
