...
class CI_Cart {
	...
	public function __construct($params = array())
	{
		...
		if ($this->CI->session->userdata_vnefrc('cart_contents') !== FALSE)
		{
			$this->_cart_contents = $this->CI->session->userdata_vnefrc('cart_contents');
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->CI->session->unset_userdata_vnefrc('cart_contents');
		...
		$this->CI->session->set_userdata_vnefrc(array('cart_contents' => $this->_cart_contents));
