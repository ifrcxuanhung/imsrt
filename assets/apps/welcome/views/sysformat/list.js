                ...
                $(document).ready(function()
                {
                   ...
                   var $string = location.search;
                    ...
                    var getTable = function(current){
                        ...
                        $.ajax({
                            url: $base_url + 'sysformat/getConfig?table=' + $table,
                            type: 'post',
                            async: false,
                            success: function(rs){
                                ...
                                if(rs != 0){
                                   ...
                                   var myGrid = $($idRender).jqGrid({
                                        url: $base_url + 'sysformat/index?table=' + $table,
                                        datatype: 'json',
                                        mtype: 'GET',
                                        ...
                                        resizeStop: function(newwidth,index){
                                            ...
                                            $.ajax({
                                                url: $base_url + 'sysformat/updateWidth?table=' + $table + '&header=' + columnNames[index] + '&width=' + newwidth,
                                                type: 'get',
                                                async: false
                                            });
                                        },
                                        ...
                                        editurl: $base_url + 'sysformat/edit?table=' + $table,
                                        pager: jQuery('#pager'),
                                        rowNum:20,
                                        rowList:[10,20,30],
                                        sortname: 'id',
                    ...
                    $($idRender).jqGrid(
                        ...
                        '#pager',
                        {
                            ...
                            onClickButton:function(){
                                $.ajax({
                                    url: $base_url + 'sysformat/export?table=' + $table,
                                    type: 'get',
                                    async: false,
                                    success: function(rs){
                                        rs = JSON.parse(rs);
