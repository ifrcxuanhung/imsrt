define([
    ...
    'backbone'
        ...
        var jq_compare_twoView = Backbone.View.extend({
            el: $(".main-container"),
            initialize: function(){
		   ...
		   var filter_get_all = $(".filter_get_all").attr('attr');
            ...
            $("#jqGrid").jqGrid({
               // url: 'ajax/jq_efrc_currency_data',
			    url: $base_url+'ajax/jq_compare_two_composition',
				editurl: $base_url+'jq_compare_two/edit_del_add_jq_compare_two?jq_table='+jq_table,
			 ...
			 $("#jqGrid2").jqGrid({
               // url: 'ajax/jq_efrc_currency_data',
			    url: $base_url+'ajax/jq_compare_two_specs',
				editurl: $base_url+'jq_compare_two/edit_del_add_jq_compare_two?jq_table='+jq_table2,
			...
			$("#jqGrid3").jqGrid({
               // url: 'ajax/jq_efrc_currency_data',
			    url: $base_url+'ajax/jq_loadtop_composition_two',
			...
			$("#jqGrid4").jqGrid({
               // url: 'ajax/jq_efrc_currency_data',
			    url: $base_url+'ajax/jq_loadtop_specs_two',
			...
			function formatLinkDefault(cellValue, options, rowObject) {
                return "<a href='"+$base_url+"jq_compare_two/" + cellValue + "' class='link_overview'>" + cellValue.substring(0, 25) + "</a>";
            };
